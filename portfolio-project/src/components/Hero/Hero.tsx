...
const Hero = () => {
  ...
  return (
    <div className="div-container">
      <div className="flex flex-row justify-center items-center max-w-3xl gap-4 my-4">
      ...
      <div className="flex flex-col sm:flex-row sm:gap-8">
        <Button label={t("projectsButton")} href="/projects" className="" />
        <Button label={t("contactMeButton")} href="/contact" className="" />
      </div>
